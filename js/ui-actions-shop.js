// ╔══════════════════════════════════════════════════════════════════╗
// ║  ui-actions-shop.js  —  Tienda, inventario, config, modales     ║
// ║  Contiene: renderShop, renderInventory, openRedeem, addMission  ║
// ║             addItem, saveRanks, resetAll, loadVisionBoard       ║
// ║  Depende de: storage.js, rewards.js, ui-actions-missions.js    ║
// ╚══════════════════════════════════════════════════════════════════╝
// ╚══════════════════════════════════════════════════════════════════════════╝
